#  Payam Resan GO SMS API Examples

نمونه کدهای آماده GO برای اتصال به **وب‌سرویس پیامکی پیام‌رسان**  
...
در این ریپازیتوری، **نمونه‌کدهای GO برای استفاده از متدهای مختلف وب‌سرویس پیام‌رسان** قرار داده شده است. اگر توسعه‌دهنده GO هستید، می‌توانید به راحتی با این کدها، سامانه پیام‌رسان را به برنامه خود متصل کنید.
